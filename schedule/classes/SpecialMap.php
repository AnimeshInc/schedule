...
class SpecialMap extends BaseMap {
    ...
    private function insert(Special $special){
        ...
        active)" . " VALUES($name, $special->otdel_id, $special->active)") == 1) {
    ...
    private function update(Special $special){
        ...
        . " otdel_id = $special->otdel_id, active = 
        $special->active WHERE special_id = ". $special->special_id) == 1) {
        return true;
        }
        return false;
    }
    public function findAll($ofset = 0, $limit = 30){
        ...
        special.name, special.active, otdel.name AS otdel"
